...
function render(input, out, __component, component, state) {
  ...
  out.w("<!DOCTYPE html><html lang=en><head><meta charset=UTF-8><title>UseVibe - Início</title><link rel=stylesheet href=https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css><link rel=stylesheet href=https://cdnjs.cloudflare.com/ajax/libs/simple-line-icons/2.2.4/css/simple-line-icons.min.css><link rel=stylesheet href=styles/style.css></head><body><nav><div class=mini><p class=products>Empty</p><p class=names></p><p class=miniprice></p><p class=id></p><form" +
    marko_attr("action", "/comprar") +
    " method=post><input type=submit value=\"comprar agora\"></form></div><ul><li><a href=/ >Home</a></li><li><a href=/login>Login</a></li><li><a href=/cadastro>Cadastro</a></li><li><a href=/feminino>Feminino</a></li><li><a href=/masculino>Masculino</a></li><li><a href=/infantil>Infantil</a></li><li>Contato</li></ul><span style=margin-left:150px;>bem vindo - " +
  ...
  marko_forOf(data.results, function(produto, index) {
    ...
    out.w("<div class=product><img" +
      ...
      "</p><div class=btn>preço</div><div class=quickview>Add carrinho</div></div>");
  });
